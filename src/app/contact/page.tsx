  ...
  return (
    <div>
          <div className='flex flex-col h-[calc(100vh-6rem)] md:h-[calc(100vh-9rem)]  lg:flex-row bg-fuchsia-50 '>
              {/* TEXT CONTAINER */}
        <div className='h-1/2 flex items-center justify-center flex-col gap-8 text-red-300 font-bold lg:h-full lg-w-1/2 '>
          <h1 className='text-2xl text-center uppercase py-4 md:text-6xl  xl:text-7xl '>
